...
DISPLAY_NAME = 'Supply'
cats = ['the-single-edge-razors', 'grooming-essentials', 'skincare', 'accesories', 'the-single-edge-starter-set']
cat_names = ['Razors', 'Grooming essentials', 'Skin Essentials', 'Blades and accesories']
imgs = ['https://drive.google.com/open?id=1H8UNVhHSD1Mad3EvREQiBd9b-1F_BsxE',
 'https://drive.google.com/open?id=1MZ_ygkDygd_HzLLPCDU2pft0xR-BdEmL',
 'https://drive.google.com/open?id=1l_j16J51RIelM_t9ugj7Jz0bFmnF9LbW',
 'https://drive.google.com/open?id=1cnwoAuFrp_9BK_ekdGLcXf1yiwjO_SOm',
 'https://drive.google.com/open?id=1J8qPRujU0GGqR2lEyRnKCtYU3650MCym',
 'https://drive.google.com/open?id=1E1izkSViYr8km5kVuOSCFvnDapw3Uchn']
