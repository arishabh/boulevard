...
# Some general tags have been already added, add onto themj
NAME = 'marinelayer'  # e.g. onlyny | Has to be the same as on url (lowercase)
        ...
        for d in data:
            ...
            for color in colors:
                ...
                for fit in fits:
                    ...
                    if not d['body_html']: d['body_html'] = ""
