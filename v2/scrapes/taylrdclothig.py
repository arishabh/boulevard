...
NAME = 'taylrdclothing'  # e.g. onlyny | Has to be the same as on url (lowercase)
DISPLAY_NAME = 'Taylrd'
cats = ['new-tops', 'new-bottoms', 'all-chinos', '5-pockets', 'shorts', 'joggers', 'long-sleeve-button-downs',
        'short-sleeve', 'hoodies-and-jackets', 'hoodies', 'henleys-and-tees', 'brushed-button-downs']
        ...
        for d in data:
            ...
            for option in d['options']:
                if (option['name'] == 'Color'):
                    ...
                    fits = option['values']
                elif (option['name'] == 'Pant Waist'):
                    waist = option['values']
                elif (option['name'] == 'Pant Length'):
